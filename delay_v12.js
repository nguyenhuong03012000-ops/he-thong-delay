...
window.delayModule = (function () {
    ...
    function renderDashboard(res) {
        ...
        function buildRow(keys, o) {
            ...
            // Action Link: intercept pancake conversation_link to rewrite the FB Node ID accurately to the Page ID
            let customLink = o.conversation_link ? o.conversation_link.replace(/\/[0-9]+\?/, `/${o.page_id}?`) : `https://pos.pancake.vn/snack/orders?query=${o.order_id}`;
