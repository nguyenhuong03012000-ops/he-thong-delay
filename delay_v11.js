...
window.delayModule = (function () {
    ...
    function processLogic(orders) {
        ...
        orders.forEach(o => {
            ...
            const dropStatuses = ["đợi xác nhận", "đã xác nhận", "hủy", "cancel", "hủy đơn", "đã hủy", "mới", "new", "submitted", "packing", "đóng hàng", "wait submit", "chờ chuyển"];
    ...
    function renderDashboard(res) {
        ...
        function buildRow(keys, o) {
            ...
            // Action Link: native jump to POS chat if conversation_link exists!
            let customLink = o.conversation_link ? o.conversation_link : `https://pos.pancake.vn/snack/orders?query=${o.order_id}`;
