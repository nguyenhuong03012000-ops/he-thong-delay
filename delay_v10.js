...
window.delayModule = (function () {
    ...
    function processLogic(orders) {
        ...
        orders.forEach(o => {
            ...
            const dropStatuses = ["đợi xác nhận", "đã xác nhận", "hủy", "cancel", "hủy đơn", "đã hủy", "mới", "new", "submitted"];
    ...
    function renderDashboard(res) {
        ...
        function buildRow(keys, o) {
            ...
            // Action Link: native jump to POS chat if conversation_id exists!
            let customLink = o.conversation_id ? `https://pancake.vn/${o.page_id}/messages/${o.conversation_id}` : `https://pos.pancake.vn/snack/orders?query=${o.order_id}`;
