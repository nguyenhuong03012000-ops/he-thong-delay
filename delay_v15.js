...
window.delayModule = (function () {
    ...
    function applyFilters() {
        ...
        const fCustomer = document.getElementById('filterCustomer') ? document.getElementById('filterCustomer').value.toLowerCase().trim() : '';
        const fTag = document.getElementById('filterTag') ? document.getElementById('filterTag').value.toLowerCase().trim() : '';
    ...
    ['filterMarket', 'filterCarrier', 'filterCity', 'filterDateFrom', 'filterDateTo', 'filterCustomer', 'filterTag'].forEach(id => {
